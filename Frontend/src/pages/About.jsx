...
function About() {
  ...
  console.log(profile);
  return (
    <div className="container mx-auto mt-25 p-4 space-y-9">
      ...
      <p>
        ...
        dynamic, responsive, and user-friendly web applications, Pankaj excels in
      ...
      <br />
      <span>
        Pankaj is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        Beyond his professional achievements, Pankaj is a big fan of cricket and
        ...
        significantly shaped Pankaj’s journey. Ankush is not only a great
        competitor but also a steadfast friend, constantly motivating Pankaj to
